...
public class testingAuto extends LinearOpMode{
    ...
    double kDrive[] = {0.44, 1.27, 0.54};
    double kRotate[] = {0.84, 3.188, 0.41};
    ...
    public void runOpMode(){
        ...
        for(int i = 0; i < 3 && cheese == "none"; i++) {
            if(i == 0){
                doublePID(-4.21, 1.64, 1.64, false);
            }
            if(i == 1){
                doublePID(-4.41, 1.53, 0.81, false);
            }
            if(i == 2){
                doublePID(-4.31, 1.69, 2.09, false);
            }
            //checkCheese();
        }
        if(cheese == "none"){
        ...
        if(cheese == "center"){
            doublePID(-17.62, 2.55, 1.49, false);
            dropMarker();
            doublePID(-4.21, 1.64, 1.64, true);
            doublePID(-5.13, 0.89, 3.1, false);
            doublePID(-10.16, -19.95, 3.82, false);
            doublePID(-7.42, -23.06, 3.81, false); //(0, -32.46, 3.8, false) if you need to go deep
    ...
    public void armExtend(int position){
        double startTime = runtime.milliseconds();
    ...
    public void dropMarker(){
        shell.chungoid1.setPosition(0.2);
        shell.chungoid2.setPosition(0.8);
        sleepNotSleep(500);
        ...
        shell.chungoid1.setPosition(0.9);
        shell.chungoid2.setPosition(0.1);
    }
    ...
    //             cheese = "center";
    //         }
    //         if (roboAngle > Math.PI / 12 && roboAngle < Math.PI / 2) {
    //             cheese = "left";
    //         }
    //         if (roboAngle < -Math.PI / 12 && roboAngle > -Math.PI / 2) {
    //             cheese = "right";
